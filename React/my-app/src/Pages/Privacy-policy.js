...
function Privacy_policy() {
    ...
    return (
        <div>
            ...
            <div className='ppdiv'>
                <p>Last updated: September 5, 2023</p>
                <p>This Privacy Policy describes how BAROQUE (Bilal Textile)  (the "<b>Site</b>", "<b>we</b>", "<b>us</b>", or "<b>our</b>") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from baroque.pk (the "<b>Site</b>") or otherwise communicate with us (collectively, the "<b>Services</b>"). For purposes of this Privacy Policy, "<b>you</b>" and "<b>your</b>" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.</p>
                ...
                <h2 className='pph1'>Changes to This Privacy Policy</h2>
                ...
                <h2 className='pph1'>How We Collect and Use Your Personal Information</h2>
                ...
                <h2 className='pph1'>What Personal Information We Collect</h2>
                ...
                <h2 className='pph1'>Information We Collect Directly from You</h2>
                ...
                <ul>
                    ...
                    <li><b>Account information</b> including your username, password, security questions.</li>
                    <li><b>Shopping information</b> including the items you view, put in your cart or add to your wishlist.</li>
                    <li><b>Customer support information</b> including the information you choose to include in communications with us, for example, when sending a message through the Services.</li>
                </ul>
                ...
                <h2 className='pph1'>Information We Collect through Cookies</h2>
                <p>We also automatically collect certain information about your interaction with the Services ("<b>Usage Data</b>"). To do this, we may use cookies, pixels and similar technologies ("<b>Cookies</b>"). Usage Data may include information about how you access and use our Site and your account, including device information, browser information, information about your network connection, your IP address and other information regarding your interaction with the Services.</p>
                ...
                <h2 className='pph1'>How We Use Your Personal Information</h2>
                <ul>
                ...
                <h2 className='pph1'>Cookies</h2>
                <p>Like many websites, we use Cookies on our Site. For specific information about the Cookies that we use related to powering our store with Shopify, see <a href='https://www.shopify.com/pk/legal/cookies' target='_blank' rel='noreferrer'>https://www.shopify.com/pk/legal/cookies</a>. We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services (in our legitimate interests to administer, improve and optimize the Services). We may also permit third parties and services providers to use Cookies on our Site to better tailor the services, products and advertising on our Site and other websites.</p>
                ...
                <h2 className='pph1'>How We Disclose Personal Information</h2>
                ...
                <ul>
                    ...
                    <li>With business and marketing partners, including - Shopify, Facebook, Google, Shopify and TikTok, to provide services and advertise to you. Our business and marketing partners will use your information in accordance with their own privacy notices.</li>
                ...
                <p>We have, in the past 12 months disclosed the following categories of personal information and sensitive personal information (denoted by *) about users for the purposes set out above in <i>"How we Collect and Use your Personal Information" and "How we Disclose Personal Information":</i></p>
                ...
                <h2 className='pph1'>User Generated Content</h2>
                ...
                <h2 className='pph1'>Third Party Websites and Links</h2>
                ...
                <h2 className='pph1'>Children’s Data</h2>
                ...
                <h2 className='pph1'>Security and Retention of Your Information</h2>
                ...
                <h2 className='pph1'>Your Rights and Choices</h2>
                ...
                <p>We use Shopify's ad services such as Shopify Audiences to help personalize the advertising you see on third party websites. To restrict Shopify merchants that use these ad services from using your personal information for such services, visit <a href="https://privacy.shopify.com/en">https://privacy.shopify.com/en.</a></p>
                <p>We use Facebook ad services such as Facebook Pixel to help personalise the advertising you see on third party websites. To understand what data Facebook (Meta) uses for advertising visit <a href="https://www.facebook.com/privacy/policy/" target='blank'> https://www.facebook.com/privacy/policy/.</a></p>
                <p>We use Google ad services such as Google Tags to help personalise the advertising you see on third party websites. To understand what data Google uses for advertising visit <a href="https://policies.google.com/technologies/ads?hl=en-US" target='blank'>https://policies.google.com/technologies/ads?hl=en-US.</a></p>
                <p>We use TikTok ad services such as TikTok Pixel to help personalise the advertising you see on third party websites. To understand what data TikTok uses for advertising visit <a href="https://www.tiktok.com/legal/page/row/privacy-policy/en" target='blank'>https://www.tiktok.com/legal/page/row/privacy-policy/en.</a></p>
                <p>We use Snapchat ad services such as Snap Pixel to help personalise the advertising you see on third party websites. To understand what data Snapchat (Snap) uses for advertising visit <a href="https://values.snap.com/privacy/ads-privacy" target='blank'> https://values.snap.com/privacy/ads-privacy.</a></p>
                <h2 className='pph1'>Complaints</h2>
                ...
                <h2 className='pph1'>International Users</h2>
                ...
                <h2 className='pph1'>Contact</h2>
                <p>Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please email us at info@baroque.pk</p>
            </div>
