    ...
    return (
        <div>
            ...
            <div className='ppdiv'>
                ...
                <p>Like many websites, we use Cookies on our Site. For specific information about the Cookies that we use related to powering our store with Shopify, see <Link href=''>https://www.shopify.com/legal/cookies.</Link> We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services (in our legitimate interests to administer, improve and optimize the Services). We may also permit third parties and services providers to use Cookies on our Site to better tailor the services, products and advertising on our Site and other websites.</p>
                ...
                <p>We use Shopify's ad services such as Shopify Audiences to help personalize the advertising you see on third party websites. To restrict Shopify merchants that use these ad services from using your personal information for such services, visit https://privacy.shopify.com/en.</p>
                <p>We use Facebook ad services such as Facebook Pixel to help personalise the advertising you see on third party websites. To understand what data Facebook (Meta) uses for advertising visit https://www.facebook.com/privacy/policy/.</p>
                <p>We use Google ad services such as Google Tags to help personalise the advertising you see on third party websites. To understand what data Google uses for advertising visit https://policies.google.com/technologies/ads?hl=en-US.</p>
                <p>We use TikTok ad services such as TikTok Pixel to help personalise the advertising you see on third party websites. To understand what data TikTok uses for advertising visit https://www.tiktok.com/legal/page/row/privacy-policy/en.</p>
                <p>We use Snapchat ad services such as Snap Pixel to help personalise the advertising you see on third party websites. To understand what data Snapchat (Snap) uses for advertising visit https://values.snap.com/privacy/ads-privacy.</p>
