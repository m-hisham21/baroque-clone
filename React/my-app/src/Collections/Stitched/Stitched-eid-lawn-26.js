...
import "./Stitched-eid-lawn-26.css";
import { useNavigate } from "react-router-dom";
import NavDropdown from 'react-bootstrap/NavDropdown';
import Nav from 'react-bootstrap/Nav';

function Stitched_eid_lawn_26() {
  const navigate = useNavigate();
  return (
    <div>
      <h1 className='stitched-26-h1'>Stiched Eid Lawn</h1>
      <button className='stitched-26-EL' onClick={() => navigate("/Stitched-eid-lawn-25")}>EID LAWN 25</button>
      <button className='stitched-26-EL' onClick={() => navigate("/Stitched-eid-lawn-26")}>EID LAWN 26</button>

      <div className='stitched-26-containers'>
        <div className='stitched-26-height-observer'>
          <div className='stitched-26-sort-filter-btn'>
            <button className='stitched-26-sortby-filtter-btns'>filter</button>
            <Nav id='stitched-26-nav-dd'>
          ...
          <div className='stitched-26-c-l-s'>
          ...
          <p id='stitched-26-ten-product'>8 PRODUCTS</p>
        </div>
        <div className='stitched-26-details-products-maindiv'>
          <div className='stitched-26-sidebar-filter'>
            <Accordion alwaysOpen>

              <Accordion.Item style={{ marginLeft: "10px", border: "none", borderBottom: "1px solid rgb(185, 183, 183)" }} eventKey="0">
                <Accordion.Header > <p className='stitched-26-acrdin-head-p'> Availability </p></Accordion.Header>
                <Accordion.Body>
              ...
              <Accordion.Item style={{ marginLeft: "10px", border: "none", borderBottom: "1px solid rgb(185, 183, 183)" }} eventKey="1">
                <Accordion.Header > <p className='stitched-26-acrdin-head-p'> Price </p></Accordion.Header>
                <Accordion.Body>
              ...
              <Accordion.Item style={{ marginLeft: "10px", border: "none", borderBottom: "1px solid rgb(185, 183, 183)" }} eventKey="2">
                <Accordion.Header > <p className='stitched-26-acrdin-head-p'> Type</p></Accordion.Header>
                <Accordion.Body>
                  UNSTITCHED (10)
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item style={{ marginLeft: "10px", border: "none", borderBottom: "1px solid rgb(185, 183, 183)" }} eventKey="3">
                <Accordion.Header > <p className='stitched-26-acrdin-head-p'> Fabric</p></Accordion.Header>
                <Accordion.Body>
                  Lawn(10)
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item style={{ marginLeft: "10px", border: "none", borderBottom: "1px solid rgb(185, 183, 183)" }} eventKey="4">
                <Accordion.Header > <p className='stitched-26-acrdin-head-p'> Size</p></Accordion.Header>
                <Accordion.Body>
                  DEFAULT (10)
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item style={{ marginLeft: "10px", border: "none", borderBottom: "1px solid rgb(185, 183, 183)" }} eventKey="5">
                <Accordion.Header > <p className='stitched-26-acrdin-head-p'> Pices</p></Accordion.Header>
                <Accordion.Body>
                  3 PIECE (10)
                </Accordion.Body>
              </Accordion.Item>
          ...
          <div className='stitched-26-all-products'>
            <div className='stitched-products-imgs-row'>
              ...
              <p className="stitched-26-pd1">EMBROIDERED LAWN EL26-D07 STITCHED-26</p>
              <p className="stitched-26-pd2"><b>PKR 26,950.00</b></p>
              <p className="stitched-26-pd3">EID LAWN 26</p>
            </div>
            <div className='stitched-products-imgs-row'>
              ...
              <button className='add-to-cart-popup-btn'><span className='add-btn'>+</span></button>
              <button className='wishlist-btn-on-img'>♡</button>
              <p className="stitched-26-pd1">EMBROIDERED LAWN EL26-D08 STITCHED-26</p>
              <p className="stitched-26-pd2"><b>PKR 26,950.00</b></p>
              <p className="stitched-26-pd3">EID LAWN 26</p>
            </div>
            <div className='stitched-products-imgs-row'>
              ...
              <button className='add-to-cart-popup-btn'><span className='add-btn'>+</span></button>
              <button className='wishlist-btn-on-img'>♡</button>
              <p className="stitched-26-pd1">EMBROIDERED LAWN EL26-D03 STITCHED-26</p>
              <p className="stitched-26-pd2"><b>PKR 26,950.00</b></p>
              <p className="stitched-26-pd3">EID LAWN 26</p>
            </div>
            <div className='stitched-products-imgs-row'>
              ...
              <button className='add-to-cart-popup-btn'><span className='add-btn'>+</span></button>
              <button className='wishlist-btn-on-img'>♡</button>
              <p className="stitched-26-pd1">EMBROIDERED LAWN EL26-D04 STITCHED-26</p>
              <p className="stitched-26-pd2"><b>PKR 26,950.00</b></p>
              <p className="stitched-26-pd3">EID LAWN 26</p>
            </div>
            ...
            <div className='stitched-products-imgs-row'>
              ...
              <button className='add-to-cart-popup-btn'><span className='add-btn'>+</span></button>
              <button className='wishlist-btn-on-img'>♡</button>
              <p className="stitched-26-pd1">EMBROIDERED LAWN EL26-D05 STITCHED-26</p>
              <p className="stitched-26-pd2"><b>PKR 26,950.00</b></p>
              <p className="stitched-26-pd3">EID LAWN 26</p>
            </div>
            <div className='stitched-products-imgs-row'>
              ...
              <button className='add-to-cart-popup-btn'><span className='add-btn'>+</span></button>
              <button className='wishlist-btn-on-img'>♡</button>
              <p className="stitched-26-pd1">EMBROIDERED LAWN EL26-D06 STITCHED-26</p>
              <p className="stitched-26-pd2"><b>PKR 26,950.00</b></p>
              <p className="stitched-26-pd3">EID LAWN 26</p>
            </div>

            <div className='stitched-26-products-imgs-row'>
              <img className='stitched-26-products-imgs' src='https://baroque.pk/cdn/shop/files/53_1329846c-cd09-4066-bbab-48c8ffaf08cc.jpg?v=1770631769&width=1200' alt='' />
              <button className='add-to-cart-popup-btn'><span className='add-btn'>+</span></button>
              <button className='wishlist-btn-on-img'>♡</button>
              <p className="stitched-26-pd1">EMBROIDERED LAWN EL26-D02 STITCHED-26</p>
              <p className="stitched-26-pd2"><b>PKR 26,950.00</b></p>
              <p className="stitched-26-pd3">EID LAWN 26</p>
            </div>
            <div className='stitched-products-imgs-row'>
...
export default Stitched_eid_lawn_26
