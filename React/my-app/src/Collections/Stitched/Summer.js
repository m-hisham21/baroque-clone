        ...
        <div className='stitched-height-observer'>
          ...
          <div className='stitched-c-l-s'>
            <collection-layout-switch
              ...
              <button type="button" id="stitched-left-fix-btns"
                title="Grid viwe" aria-label="Switch to larger product images">
                <svg role="presentation" width="18" viewBox="0 0 18 18" fill="none">
                  <path
                    fill="currentColor"
              ...
              <button type="button" id="stitched-left-fix-btns" value="medium" title="Compact grid view" class="collection-toolbar__button" aria-label="Switch to smaller product images">
                <svg role="presentation" width="18" viewBox="0 0 18 18" fill="none">
                  <path fill="currentColor" d="M0 0h4v4H0zM7 0h4v4H7zM14 0h4v4H14z M0 7h4v4H0zM7 7h4v4H7zM14 7h4v4H14z M0 14h4v4H0zM7 14h4v4H7zM14 14h4v4H14z"> </path>
                </svg>
              </button>

              <button type="button" id="stitched-left-fix-btns" value="compact" title="List view" class="collection-toolbar__button" aria-label="Switch to compact product images">
                <svg role="presentation" width="18" viewBox="0 0 18 18" fill="none">
          ...
          <p id='stitched-ten-product'>104 PRODUCTS</p>
        </div>
